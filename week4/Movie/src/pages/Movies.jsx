    ...
    <CategoryContainer>
      {category === undefined && (
        <>
          <Title>카테고리</Title>
          <CategoryBoxes>
            <CategoryBox to="/movies/category/now-playing">현재 상영중인</CategoryBox>
            <CategoryBox to="/movies/category/popular">인기있는</CategoryBox>
            <CategoryBox to="/movies/category/top-rated">높은 평가를 받은</CategoryBox>
            <CategoryBox to="/movies/category/up-coming">개봉 예정중인</CategoryBox>
          </CategoryBoxes>
        </>
      )}
